...
const textToType = textToTypeElement.innerText.split(" ");
...
function calculateWPM() {
  ...
  const currentTime = new Date(); // Mendapatkan currentTime di sini
  const elapsedTime = Math.floor((currentTime - startTime) / 1000);
...
function checkInput() {
  ...
  // hapus kelas jika pengguna menghapus teks yang sudah diketik sebelumnya
